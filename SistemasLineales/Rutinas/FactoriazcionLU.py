...
def FactorizacionLU_Doolittle(matrizA:np.ndarray) -> tuple[np.ndarray,np.ndarray]:
  """
    ...
    matrizA : np.ndarray :: Matriz cuadrada
...
def FactorizacionLU_Choleski(matrizA:np.ndarray) -> np.ndarray:
  """
    Procedimiento para factorizar una matriz cuadrada 
    ...
    matrizA : np.ndarray :: Matriz cuadrada simétrica
...
def __Elemento_ijMatrizL(index_i:int,index_j:int,matrizA:np.ndarray,matrizL:np.ndarray) -> None:
  """
    ...
    matrizA : np.ndarray :: Matriz original a factorizar
    matrizL : np.ndarray :: Matriz resultante de la factorización 
...
def FactorizacionLUPivoteo_Doolittle(matrizA:np.ndarray) -> tuple[np.ndarray,np.ndarray,list[int],list[int]]:
  """
    Procedimiento para factorizar una matriz cuadrada 
    A en el producto de una matriz triangular inferior L 
    y una superior U, haciendo uso de la restricción 
